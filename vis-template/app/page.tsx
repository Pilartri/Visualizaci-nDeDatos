  ...
  return ( 
    <div className="bg-gray-50 bg-white shadow-md">
      ...
      <section className="container mx-auto py-24 pt-80 mt-[-320px]">
        ...
        <button className="bg-orange-500 hover:bg-orange-300 text-white font-bold py-2 px-4 rounded mt-8 ml-[385px]"
        onClick={() => window.open()}>
       Conocé más 
        </button>
      </section>
...
{/* conclusión */}
<section className="container mx-auto">
        <h2 className="text-5xl font-black text-center mb-6 text-orange-500">PARTICI[PAR]</h2>
        <p className="text-center mb-8 text-gray-600 text-lg font-thin">
        ...
        <button className="bg-orange-500 hover:bg-orange-300 text-white font-bold py-2 px-4 rounded mt-8 ml-[500px]"
        onClick={() => window.open()}>
